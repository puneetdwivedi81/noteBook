  ...
  return (
    <>
      ...
      <div className="overflow-hidden transition-shadow relative duration-300 bg-white rounded shadow-sm">
        ...
        <img
          src={image ? image : "https://images.pexels.com/photos/447592/pexels-photo-447592.jpeg?auto=compress&amp;cs=tinysrgb&amp;dpr=2&amp;h=750&amp;w=1260"}
          className="object-cover w-full h-64"
          alt=""
        />
        <div className="p-5">
          <p className="mb-3 flex justify-between items-center text-xs font-semibold tracking-wide uppercase">
            <span className="text-gray-600">
              {new Date(updatedAt).toLocaleString()}
            </span>
            {category == "public" ? <Earth /> : <LockKeyhole />}
          </p>
          ...
          <p className="mb-2 text-gray-500">{tag?.join("  ")}</p>
          <a
            href="/"
            aria-label=""
